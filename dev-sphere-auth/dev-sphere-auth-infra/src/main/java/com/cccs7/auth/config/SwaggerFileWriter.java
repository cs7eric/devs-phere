...
public class SwaggerFileWriter implements CommandLineRunner {
    ...
    private void writeApiDocsToFile() {
        String url = "http://localhost:3011/v2/api-docs?group=auth-service"; // 确保服务已启动并且URL正确
        String outputPath = "G:/project-repo/dev-sphere-front/auth-openapi.json"; // 指定输出路径
